...
window.MS_STRINGS_EN = {
  ...
  'prompt.renameSetlist':             'Rename setlist:',
  ...
  'scrollDuration.title':          '⏱ Scroll duration',
  'scrollDuration.hint':           'Set how long you\'d like auto-scroll to take to reach the bottom of the page — the speed is calculated for you.',
  'scrollDuration.minutesLabel':   'Minutes',
  'scrollDuration.secondsLabel':   'Seconds',
  'scrollDuration.apply':          'Start scrolling',
  ...
  'sidebar.setlists':           '🎼 Setlists',
  'sidebar.setlistsTitle':      'Switch to your setlists',
  'sidebar.setlistsHeader':     'Setlists',
  'sidebar.add':                '＋ Add',
  'sidebar.exportSetlists':     'Export setlists',

  // ── SETLISTS ─────────────────────────────────────────────────────────────
  'setlist.addTitle':           '🎼 Add to setlist',
  'setlist.addHint':            'Tick songs to add. Type a new name below to create a setlist, or pick an existing one to add into it.',
  'setlist.nameLabel':          'Setlist',
  ...
  'setlist.backToSetlists':     'Back to setlists',
  'setlist.dragToReorder':      'Drag to reorder',
  'confirm.removeSetlist':      'Delete "{name}"? This removes it and all its song copies — the original library songs are not affected.',
  'alert.setlistNameRequired':      'Enter a name for the setlist.',
  'alert.setlistNoSongsSelected':   'Tick at least one song to add.',
  'alert.invalidSetlistsFile':      'That file doesn\'t look like a Magic Scroll setlists export.',
  'setlist.importSummary':          'Imported {songs} song(s) into {setlists} setlist(s).',
  ...
  'kebab.addToSetlist':         '🎼 Add to setlist',
  ...
  'kebab.setlistOptions':       'Setlist options',
  'kebab.export':                '⬇ Export',
