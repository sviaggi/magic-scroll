...
window.MS_STRINGS_FR = {
  ...
  'prompt.renameSetlist':             'Renommer la set-list :',
  ...
  'scrollDuration.title':          '⏱ Durée du défilement',
  'scrollDuration.hint':           'Indiquez le temps souhaité pour que le défilement automatique atteigne le bas de la page — la vitesse est calculée pour vous.',
  'scrollDuration.minutesLabel':   'Minutes',
  'scrollDuration.secondsLabel':   'Secondes',
  'scrollDuration.apply':          'Démarrer le défilement',
  ...
  'sidebar.setlists':           '🎼 Set-lists',
  'sidebar.setlistsTitle':      'Passer à vos set-lists',
  'sidebar.setlistsHeader':     'Set-lists',
  'sidebar.add':                '＋ Ajouter',
  'sidebar.exportSetlists':     'Exporter les set-lists',

  // ── SET-LISTS ────────────────────────────────────────────────────────────
  'setlist.addTitle':           '🎼 Ajouter à une set-list',
  'setlist.addHint':            'Cochez les morceaux à ajouter. Saisissez un nouveau nom ci-dessous pour créer une set-list, ou choisissez-en une existante pour y ajouter les morceaux.',
  'setlist.nameLabel':          'Set-list',
  ...
  'setlist.songCount':          '{n} morceaux',
  'setlist.backToSetlists':     'Retour aux set-lists',
  'setlist.dragToReorder':      'Glisser pour réordonner',
  'confirm.removeSetlist':      'Supprimer « {name} » ? Cela supprime la set-list et toutes ses copies de morceaux — les morceaux d\'origine dans la bibliothèque ne sont pas affectés.',
  'alert.setlistNameRequired':      'Saisissez un nom pour la set-list.',
  'alert.setlistNoSongsSelected':   'Cochez au moins un morceau à ajouter.',
  'alert.invalidSetlistsFile':      'Ce fichier ne ressemble pas à un export de set-lists Magic Scroll.',
  'setlist.importSummary':          '{songs} morceau(x) importé(s) dans {setlists} set-list(s).',
  ...
  'kebab.addToSetlist':         '🎼 Ajouter à une set-list',
  ...
  'kebab.setlistOptions':       'Options de la set-list',
