...
window.MS_STRINGS_ZH = {
  ...
  'sidebar.cancel':             '取消',
  'scrollDuration.title':          '⏱ 滚动时长',
  'scrollDuration.hint':           '设置自动滚动到页面底部所需的时间——系统会自动计算滚动速度。',
  'scrollDuration.minutesLabel':   '分钟',
  'scrollDuration.secondsLabel':   '秒',
  'scrollDuration.apply':          '开始滚动',
  ...
  'sidebar.setlists':           '🎼 演出曲目单',
  'sidebar.setlistsTitle':      '切换到演出曲目单',
  'sidebar.setlistsHeader':     '演出曲目单',
  'sidebar.add':                '＋ 添加',
  'sidebar.exportSetlists':     '导出演出曲目单',

  // ── 演出曲目单 ───────────────────────────────────────────────────────────
  'setlist.addTitle':           '🎼 添加到演出曲目单',
  'setlist.addHint':            '勾选要添加的歌曲。在下方输入新名称以创建演出曲目单,或选择现有的演出曲目单加入其中。',
  'setlist.nameLabel':          '演出曲目单',
  ...
  'setlist.songCount':          '{n} 首歌曲',
  'setlist.backToSetlists':     '返回演出曲目单',
  'setlist.dragToReorder':      '拖动以重新排序',
  'confirm.removeSetlist':      '删除"{name}"？这将移除它及其所有歌曲副本——原曲库中的歌曲不受影响。',
  'alert.setlistNameRequired':      '请输入演出曲目单的名称。',
  'alert.setlistNoSongsSelected':   '请至少勾选一首歌曲来添加。',
  'alert.invalidSetlistsFile':      '该文件看起来不是 Magic Scroll 演出曲目单导出文件。',
  'setlist.importSummary':          '已将 {songs} 首歌曲导入到 {setlists} 个演出曲目单。',
